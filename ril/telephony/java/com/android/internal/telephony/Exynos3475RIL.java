...
public class Exynos3475RIL extends RIL implements CommandsInterface {
    ...
    public Exynos3475RIL(Context context, int networkMode, int cdmaSubscription, Integer instanceId) {
